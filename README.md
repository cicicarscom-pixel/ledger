...
- **Marketing Landing Page Tasarımı:** Yeni geliştirilen 'Muhasebede Yeni Çağ' konsepti iptal edilerek eski 'Muhasebe Artık Daha Akıllı, Daha Kolay' tasarımına kalıcı olarak geri dönülmüştür. `apps/marketing/app/ledger/page.tsx` bu tasarıma göre kilitlenmiştir.
...
## 10. AI Asistan Randevu Taslak Motoru (Draft Engine) & Anti-Halüsinasyon (Faz 1)
WhatsApp üzerinden alınan randevularda modelin hayali işlem yapmasını engellemek, doğru saat dilimini hesaplamak ve "draft" mekanizmasını stabil hale getirmek adına Faz 1 tamamlanmıştır:
- **Anti-Halüsinasyon Koruması (AIOrchestrator):** Modelin SUCCESS almadan "randevunuzu oluşturdum/güncelledim" demesini veya list_available_slots çağırmadan "saat dolu" demesini engelleyen Tur Sonu (Round) Kontrol mekanizması kuruldu. Regex tabanlı (Unicode ve kipleri destekleyen) koruma eklendi.
